...
public class DateUtil {
    ...
    public static void main(String[] args) {
        Date chinaTime = DateUtil.getChinaTime();
    ...
    //格式化时间格式（12小时制）（没有日期，默认为1970:01:01）
    public static final String DATE_FORMAT_HH_MM_24 = "HH:mm";
    //格式化时间格式（24小时制）
    public static final String DATE_FORMAT_HH_MM_12 = "hh:mm";
    ...
    public static int compareStrDate(String date1, String date2) throws ParseException {
     ...
     * @Description 获取给定日期字符串的下一天，日期字符串
     * @Return
     **/
    public static String getNextDateStr(String dateStr){
        DateFormat format = new SimpleDateFormat(DateUtil.DATE_FORMAT_YYYY_MM_DD);
        try {
            ...
            log.error("[getNextDateStr],获取给定日期字符串的下一天，日期字符串，失败！入参为：" + dateStr + ",错误消息为：" + e.getLocalizedMessage(),e);
            return "";
        }
    }
    ...
    public static Date formatDate(Date date,String dateFormat){
        try {
            ...
            log.error("[formatDate],格式化日期失败！入参为,date：" + date + ",dateFormat:" + dateFormat + ",错误消息为：" + e.getMessage(),e);
            return null;
        }
